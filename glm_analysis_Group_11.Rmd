...
```{r pair plot of coffee_w, fig.height = 10 , fig.width = 12, fit.align = "center", fig.cap = "\\label{fig:pp1} Pair plot of numeric variables and Qualityclass (without outliers).", message=FALSE, warning=FALSE}
...
```{r Log-Odds (Poor quality), fig.cap = "\\label{fig:lo} Point estimates and confidence intervals."}
